...
namespace Renderer {
    ...
    void ImageLoader::SetTextureSizes(Utils::Vec3U32* start) {
        int x, y, n;
    ...
    void ImageLoader::SetTextureRenderInfo(const Utils::AreaF area, const uint32_t boundTexture, const size_t id) {
        _area = area;
